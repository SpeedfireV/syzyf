...
def encoder(data, debugMode):
    ...
    if debugMode:
        ...
        additional_bits = check_table_parity(slided_message, debugMode)
    else:
        additional_bits = check_table_parity(slided_message, debugMode)
    whole_message = [data]
...
def decoder(received_message, debugMode):
    if debugMode:
        print("#DECODER#")
    ...
    if debugMode:
        ...
        decoded_parities = check_table_parity(slided_message, debugMode)
    else:
        decoded_parities = check_table_parity(slided_message, debugMode)
